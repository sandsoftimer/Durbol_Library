...
public class CollectibleObject : DurbolBehaviour
{
    ...
    public void MakeThisGunCollectable()
    {
        ...
        //gameObject.layer = ConstantManager.PLAYER_WEAPON;

        //Vector3 direction = KolpoExtensions.KVE_GetRandomDirection3D();
        //direction *= 2;
        //direction.y = 1;
        ...
        //    transform.position.KVE_ModifyThisVector(direction.x, 0, direction.z),
        //    1,
        //    weaponDroppingCurve,
        //    1, false, true, () => {

        //        vfx.transform.localPosition = vfx.transform.localPosition.KVE_ModifyThisVector(0, 0.5f, 0);
