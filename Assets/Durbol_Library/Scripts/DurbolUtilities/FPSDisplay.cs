...
public class FPSDisplay : DurbolBehaviour
{
    ...
    public override void OnSelfDistributionAction(DurbolManager kolpoPManager)
    {
        base.OnSelfDistributionAction(kolpoPManager);

        gameObject.SetActive(kolpoPManager.debugModeOn);
        //Debug.LogError(kolpoPManager.debugModeOn);
    }
