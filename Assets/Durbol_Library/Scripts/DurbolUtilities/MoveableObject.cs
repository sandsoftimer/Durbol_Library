...
public class MoveableObject : DurbolBehaviour
{
    ...
    public override void Start()
    {
        ...
        basePosition = movingTransfrom.localPosition;
        currentPosition = movingTransfrom.localPosition;
    }
    ...
    void FixedUpdate()
    {
        ...
        currentPosition += new Vector3(moveSpeed.x * xMovingDirection * Time.fixedDeltaTime, moveSpeed.y * yMovingDirection * Time.fixedDeltaTime, moveSpeed.z * zMovingDirection * Time.fixedDeltaTime);
        movingTransfrom.localScale = new Vector3(1, 1, (currentPosition.z - movingTransfrom.position.z) > 0? 1 : -1);

        movingTransfrom.localPosition = currentPosition;
    }
